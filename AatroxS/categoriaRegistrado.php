        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img height="" src="img/web/Lenovoportatil1.jpg" alt="">
                        </div>
                        <h2><a href="ResultadoCategoriaRegistrado.php?id=<?php echo $SesionIniciada?>&variable1=computadoras">Computadoras</a></h2>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            ...
                            <img src="img/web/HuaweiP30PRO1.jpg" alt="">
                        </div>
                        <h2><a href="ResultadoCategoriaRegistrado.php?id=<?php echo $SesionIniciada?>&variable1=celulares">Celulares</a></h2>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            ...
                            <img src="img/web/impresoraCannon1.jpg" alt="">
                        </div>
                        <h2><a href="ResultadoCategoriaRegistrado.php?id=<?php echo $SesionIniciada?>&variable1=impresoras">Impresoras</a></h2>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                       <div class="product-upper">
                            <img src="img/web/LogitchGPROAuriculares1.jpg" alt="" >
                        </div>
                        <h2><a href="ResultadoCategoriaRegistrado.php?id=<?php echo $SesionIniciada?>&variable1=accesorios">Accesorios</a></h2>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img src="img/web/mouseLogitech3.jpg" alt="">
                        </div>
                        <h2><a href="ResultadoCategoriaRegistrado.php?id=<?php echo $SesionIniciada?>&variable1=paquetes">Paquetes</a></h2>
