            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="cartNR.php">Cart - <span class="cart-amunt">O LPS.</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">0</span></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <div class="product-inner-category">
                                        <p>Categoria: <a href=""><?php echo $filaProducto[3];?></a>.
                                    </div> 
