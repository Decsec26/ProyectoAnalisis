...
CREATE TABLE `informacionbancaria` (
  ...
  `Enu_tipoTarjeta` enum('debito','credito') DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_cliente_FK` (`id_cliente_FK`),
  CONSTRAINT `informacionbancaria_ibfk_1` FOREIGN KEY (`id_cliente_FK`) REFERENCES `cliente` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2021-04-25 16:48:05
