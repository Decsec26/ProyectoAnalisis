...
CREATE TABLE `administrador` (
  ...
  CONSTRAINT `administrador_ibfk_1` FOREIGN KEY (`id_usuario_FK`) REFERENCES `usuario` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2021-04-25 16:45:43
