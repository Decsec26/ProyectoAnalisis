        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><a href="#"><i class="fa fa-user"></i><?php echo $nombreUsuario[0] ?></a></li>
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="product-breadcroumb">
                            <a href="indexRegistrado.php?id=<?php echo $SesionIniciada?>">Home</a>
                            <a href="ResultadoCategoriaRegistrado.php?id=<?php echo $SesionIniciada?>&variable1=<?php echo $filaProducto[3]; ?>"><?php echo $filaProducto[3]; ?></a>
                            <a href=""><?php echo $filaProducto[0];?></a>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <form action="" method="POST" class="cart">
                                        ...
                                        <button class="add_to_cart_button" name="agregar" type="submit">Añadir al carrito</button> <!-- Bton de sugerencia-->
                                    </form>   
                                    
                                    <div class="product-inner-category">
                                        <p>Categoria: <a href="ResultadoCategoriaRegistrado.php?id=<?php echo $SesionIniciada?>&variable1=<?php echo $filaProducto[3];?>"><?php echo $filaProducto[3];?></a>.
                                    </div> 
                        ...
                        <!-- TERMINA ARE DE COMENTARIO Y DESCRIPCION DEL PRODUCTO-->
                    </div>                    
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        ...
                        Siganos en nuestras redes sociales.<br> <b>Ahora escucharas el sonido de la Innovación</b></p>
