            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="indexRegistrado.php?id=<?php echo $SesionIniciada?>">Home</a></li>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                   ...
                                   <form method="POST" class="cart">
                                        ...
                                        <button class="add_to_cart_button" type="submit" name="agregar">Añadir al carrito</button> <!-- Bton de sugerencia-->
                                    </form> 
